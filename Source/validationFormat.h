...
namespace util
{
	static const int MAX_JOUR = 31;
	static const int MAX_MOIS = 62;
	...
	std::string conversionMinuscule(std::string p_texte);
	std::string conversionMajuscule (std::string p_texte);
